...
const RentalForm = ({car,user,owner}) => {
  ...
  const [pickUpAddress, setPickUpAddress] = useState({address: '', lat: null, lng: null});
  const [dropOffAddress, setDropOffAddress] = useState({address: '', lat: null, lng: null});
  ...
  const loadGooglePlacesAutocomplete = (inputId, setAddressDetails) => {
    if (!window.google) {
            ...
            <div className="px-6 border-l-2 border-r-2 border-b-2 border-gray-100">
                ...
                <div className="flex flex-col mt-6">
                    ...
                    <input
                        ...
                        onChange={() => loadGooglePlacesAutocomplete("pick-up-address", setPickUpAddress)}
                        required
                ...
                <div className="flex flex-col mt-6">
                    ...
                    <input
                        ...
                        onChange={() => loadGooglePlacesAutocomplete("drop-off-address", setDropOffAddress)
                      }
                        required
                        placeholder="Pick Up Address"
                        className="bg-transparent border-gray-100 rounded-sm border-2 p-2"
