        ...
        <div className="border-2 border-gray-200 pb-10">
            ...
            <div className="w-[70%] mx-auto mt-4 ">
                ...
                <select
                    ...
                    onChange={(event) => { setBrand(event.target.value);filterCars(event.target.value,type,price)}}
                >
            ...
            <div className="w-[70%] mx-auto mt-4">
                ...
                <select
                    ...
                    id="price"
                    className="bg-white  rounded-sm p-2  mt-2 border-2 w-full border-gray-200"
                    onChange={(event) => {setPrice(event.target.value);filterCars(brand,type,event.target.value)}}
                >
            ...
            <div className="w-[70%] mx-auto mt-4">
                ...
                <select
                    ...
                    id="type"
                    className="bg-white  rounded-sm p-2 mt-2 border-2 w-full border-gray-200"
                    onChange={(event) => {setType(event.target.value);filterCars(brand,event.target.value,price)}}
                >
            ...
            <button className="bg-blue-950 text-white w-full py-2 rounded-md"onClick={() => {setType("");setBrand("");setPrice("");filterCars("","","")}} >Reset Filter</button>
            </div>
        </div>
    );
}
